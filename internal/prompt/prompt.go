...
// TrainingText is the system prompt used in fine-tuning data. It omits the
// imperative mood rule since training examples may not follow it consistently,
// and the base model already understands imperative mood from pretraining.
const TrainingText = `You are a commit message generator. Given a git diff, produce a single conventional commit message.
